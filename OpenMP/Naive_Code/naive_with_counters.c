...
i outer loop
all loops either parallilized or vectorized
***********************************************************
*/
...
4.545455e-14 10 10
OUTPUT 1
INC_EFIELD time: 15.508020 s
ADV_EFIELD_vel time: 28.417377 s
MR_MUR time: 4.531901 s
ADV_HFIELD time: 4.884356 s
Total time: 247.788050 s

thread - 10
4.545455e-14 10 10
OUTPUT 1
INC_EFIELD time: 15.594107 s
ADV_EFIELD_vel time: 28.335701 s
MR_MUR time: 4.538694 s
ADV_HFIELD time: 4.858532 s
Total time: 244.835985 s
...
*/
         ...
         *
         * Thread = 4
         * Reading Input time: 0.004108 s
         * radius: 0.000545
         * ds: 0.000027
         * Initialization time: 0.030627 s
         * computing up to time  0.000000 
         * 4.545455e-14 100 100
         * OUTPUT 1
         * INC_EFIELD time: 40.227111 s
         * ADV_EFIELD_vel time: 146.510538 s
         * MR_MUR time: 34.164926 s
         * ADV_HFIELD time: 18.841675 s
         * Total time: 374.964704 s
         *
         * =================================
         *
         * Thread = 60
         * Reading Input time: 0.004074 s
         * radius: 0.000545
         * ds: 0.000027
         * Initialization time: 0.019550 s
         * computing up to time  0.000000 
         * 4.545455e-14 100 100
         * OUTPUT 1
         * INC_EFIELD time: 36.104000 s
         * ADV_EFIELD_vel time: 117.224961 s
         * MR_MUR time: 33.497838 s
         * ADV_HFIELD time: 15.810450 s
         * Total time: 554.079754 s
         *
         *
         * ==========Serial Code========== 
         * Reading Input time: 0.004177 s
         * radius: 0.000545
         * ds: 0.000027
         * Initialization time: 0.011411 s
         * computing up to time  0.000000 
         * 4.545455e-14 100 100
         * OUTPUT 1
         * INC_EFIELD time: 27.941065 s
         * ADV_EFIELD_vel time: 258.187057 s
         * MR_MUR time: 61.224616 s
         * ADV_HFIELD time: 20.689384 s
         * Total time: 460.241067 s
        */
 ...
 //       #pragma omp parallel for private(omp2, beta, const5, const6, extk,i) schedule(dynamic)
    ...
    void ELEC_DENS(){
        ...
        */
        ...
        // #pragma omp parallel for 
        int i;
        #pragma omp parallel for private(i,EDIF,ETEM,ee,cf,frqij,ecm,taumij,aad) //for private(EDIF,ETEM,ee,cf,frqij,ecm,taumij,aad,i) schedule(dynamic)
    ...
    //        #pragma omp parallel for private(EDIF,ETEM,ee,cf,frqij,ecm,taumij,aad,i) schedule(dynamic)
       ...
       //          denp[i][j]=den[i][j];
        ...
        #pragma omp parallel for private(i,da,dac,rec1,fnua,fnui) //for private(da,dac,rec1,fnua,fnui,i) schedule(dynamic)     
        for(i=1;i<nx;i++){
    ...
    void SETUP(){
        ...
        */
        ...
        int i;
        #pragma omp parallel for private(i)//for private(i) schedule(dynamic)
